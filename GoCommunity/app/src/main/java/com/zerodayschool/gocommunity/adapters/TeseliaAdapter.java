...
public class TeseliaAdapter extends RecyclerView.Adapter<TeseliaAdapter.ViewHolder>{
    ...
    public  TeseliaAdapter(List<Teselia> teselias){this.teseliaList = teselias;}

    public TeseliaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        View teseliaView = inflater.inflate(R.layout.card_teselia, parent, false);
        ViewHolder viewHolder = new ViewHolder(teseliaView);

        return viewHolder;
    }


    public void onBindViewHolder(TeseliaAdapter.ViewHolder holder, int position) {
        ...
        dato.setText("Dato Pokemon : "+teselia.getDatos());
    }
